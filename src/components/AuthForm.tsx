...
import { login, register, signInWithGoogle, type AuthState } from "@/app/actions/auth";
  ...
  return (
    <div className="flex flex-col gap-4">
      <form action={signInWithGoogle}>
        <button
          type="submit"
          className="flex w-full items-center justify-center gap-3 border border-zinc-700 bg-zinc-900 px-4 py-2 font-medium text-zinc-100 hover:bg-zinc-800"
        >
          <GoogleIcon />
